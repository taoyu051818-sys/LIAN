...
assert(matchRoute("GET", "/api/ops/routes"), { routeId: "ops-routes", params: {} }, "GET /api/ops/routes");
...
assertNull(matchRoute("POST", "/api/ops/routes"), "POST /api/ops/routes → null (GET only)");
