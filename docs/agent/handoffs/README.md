...
Handoffs are context-transfer notes. They are not acceptance records and must not override current code, merged GitHub PRs, `../references/PR_DERIVED_STATUS_2026-05-05.md`, the backend root README, or the dated override files.
