...
This directory contains split-era API contract/inventory documents. Treat files in this folder as historical contract context unless current code, merged PRs, root README, and override files confirm the contract is still accurate.
...
4. Current `api-route-registry.js`
5. Current backend handlers
6. Current frontend callers if relevant
